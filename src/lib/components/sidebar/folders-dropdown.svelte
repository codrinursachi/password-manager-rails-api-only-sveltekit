	...
	<DropdownMenu.Content side="right" align="start">
		<Dialog.Root>
			...
			<Dialog.Content>
				...
				>
					<Input type="text" name="folder[name]" defaultValue={folder.name} />
					<br />
					<Dialog.Footer>
						<Dialog.Close>
							{#snippet child({ props })}
		...
		<Dialog.Root>
			...
			<Dialog.Content>
				<Dialog.Header>
					<Dialog.Title>Are you sure you want to remove the selected folder?</Dialog.Title>
				</Dialog.Header>
				<Dialog.Description class="hidden">Remove folder</Dialog.Description>
				<Dialog.Footer>
					<Dialog.Close>
						{#snippet child({ props })}
							<Button
